...
Following our exploration of the [HAL (Hardware Abstraction Layer)](5.md), this chapter introduces RTIC (Real-Time Interrupt-driven Concurrency), a framework for building safe and efficient concurrent embedded applications on the micro:bit.
